...
// OnAuthenticateUpdateDevice When the User connect, update and fetch his Client IP, so it can be used to deploy Edgegap's Server
...
// OnAuthenticateUpdateCustom When the User connect, update and fetch his Client IP, so it can be used to deploy Edgegap's Server
...
// OnAuthenticateUpdateApple When the User connect, update and fetch his Client IP, so it can be used to deploy Edgegap's Server
...
// OnAuthenticateUpdateEmail When the User connect, update and fetch his Client IP, so it can be used to deploy Edgegap's Server
...
// OnAuthenticateUpdateFacebook When the User connect, update and fetch his Client IP, so it can be used to deploy Edgegap's Server
...
// OnAuthenticateUpdateFacebookInstantGame When the User connect, update and fetch his Client IP, so it can be used to deploy Edgegap's Server
...
// OnAuthenticateUpdateSteam When the User connect, update and fetch his Client IP, so it can be used to deploy Edgegap's Server
...
// OnAuthenticateUpdateGameCenter When the User connect, update and fetch his Client IP, so it can be used to deploy Edgegap's Server
...
// OnAuthenticateUpdateGoogle When the User connect, update and fetch his Client IP, so it can be used to deploy Edgegap's Server
